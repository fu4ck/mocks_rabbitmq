...
func (v *VHost) ExchangeDeclare(name, kind string, opt mocks.Option) error {
	v.mu.Lock()
	defer v.mu.Unlock()
...
func (v *VHost) ExchangeDeclarePassive(name, kind string, opt mocks.Option) error {
	v.mu.Lock()
	defer v.mu.Unlock()
...
func (v *VHost) exchangeDeclare(name, kind string, passive bool, opt mocks.Option) error {
...
func (v *VHost) QueueDeclare(name string, args mocks.Option) (mocks.Queue, error) {
	v.mu.Lock()
	defer v.mu.Unlock()
...
func (v *VHost) QueueDeclarePassive(name string, args mocks.Option) (mocks.Queue, error) {
	v.mu.Lock()
	defer v.mu.Unlock()
...
func (v *VHost) queueDeclare(name string, passive bool, args mocks.Option) (mocks.Queue, error) {
...
func (v *VHost) QueueDelete(name string, args mocks.Option) (int, error) {
	v.mu.Lock()
...
func (v *VHost) QueueBind(name, key, exchange string, options mocks.Option) error {
	v.mu.Lock()
	defer v.mu.Unlock()
...
func (v *VHost) queueBind(name, key, exchange string, _ mocks.Option) error {
	var (
		exch Exchange
		q    *Queue
		ok   bool
...
func (v *VHost) QueueUnbind(name, key, exchange string, options mocks.Option) error {
	v.mu.Lock()
	defer v.mu.Unlock()
...
func (v *VHost) queueUnbind(name, key, exchange string, _ mocks.Option) error {
	var (
		exch Exchange
		ok   bool
	)
...
func (v *VHost) Publish(exc, route string, d *Delivery, options mocks.Option) error {
	v.mu.Lock()
	defer v.mu.Unlock()
...
func (v *VHost) publish(exc, route string, d *Delivery, _ mocks.Option) error {
	var (
		exch Exchange
		ok   bool
		err  error
